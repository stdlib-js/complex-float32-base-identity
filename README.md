...
```javascript
import cidentityf from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-identity@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/complex-float32-base-identity/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/complex-float32-base-identity/actions/workflows/test.yml?query=branch:v0.1.0
